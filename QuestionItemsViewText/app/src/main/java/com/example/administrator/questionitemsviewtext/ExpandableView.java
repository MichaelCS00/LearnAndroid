package com.example.administrator.questionitemsviewtext;
...
import static com.example.administrator.questionitemsviewtext.ExpandableLayout.State.COLLAPSED;
import static com.example.administrator.questionitemsviewtext.ExpandableLayout.State.COLLAPSING;
import static com.example.administrator.questionitemsviewtext.ExpandableLayout.State.EXPANDED;
import static com.example.administrator.questionitemsviewtext.ExpandableLayout.State.EXPANDING;
...
public class ExpandableView extends FrameLayout implements View.OnClickListener, ExpandableLayout.OnExpansionUpdateListener {
    ...
    private void initView(Context context){
        ...
        LayoutInflater.from(context).inflate(R.layout.question_items_view,this);
...
//        unhelpful.setOnClickListener(this);
    ...
    public void onHelpfulButtonClicked(){
        if (state==NONE||state==UNHELPFUL){
            //点亮左侧按钮
            if (helpful!=null&&helpfulImage!=null&&helpfulText!=null&&helpfulText!=null){
